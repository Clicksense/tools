...
DIRNAME="/dev/shm/mpi"
HOSTS="node1,node2"
DATASET="/raid/ImageNet/2012/lmdb/imagenet_subset"
SCRIPTS_DIR="/home/congliangx/frameworks/tensorflow/benchmarks"
GPUIDS="0,1,2,3,4,5,6,7"
#NCCL_SOCKET_IFNAME="ib0"
NGCCONT="nvcr.io/nvidia/tensorflow:19.10-py3"
MPIRUN="/home/congliangx/openmpi-1.8/bin/mpirun -bind-to none"
...
docker exec $CONTNAME mpirun --allow-run-as-root --bind-to none -map-by slot -np $((${#hosts[@]} * ${#gpus[@]})) -x NCCL_DEBUG=INFO  python scripts/tf_cnn_benchmarks/tf_cnn_benchmarks.py --model=vgg16 --batch_size=256 --use_fp16 --num_batches=200 --variable_update=horovod
