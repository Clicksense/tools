CONTNAME="mpi_nccl_tt"
JOBID="mpi_nccl_tt"
DIRNAME="/dev/shm/mpi_tt"
HOSTS="node1,node2"
...
VOLS="-v $SCRIPTS_DIR:/home/congliangx"
...
docker exec $CONTNAME mpirun --allow-run-as-root -bind-to none  -map-by slot -np 2   -x NCCL_DEBUG=INFO ./build/all_reduce_perf -b 8 -e 128M -f2 -g1
